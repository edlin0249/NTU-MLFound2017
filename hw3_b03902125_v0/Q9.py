...
pl.plot(iteration, Eout, label='gradient descent')
pl.plot(iteration, Eout_SGD, label='stochastic gradient descent')
pl.title('Eout v.s. iterations, lr='+str(lr))# give plot a title
